...
**현재 버전: 1.17.0** (E2E 모듈 마감 — 이슈 #12 증분 4, TODO-97)
...
**▶ 즉시 다음 후보** (이슈 #12 증분 4 종결 — E2E 모듈 1.11.0~1.17.0 완성). 아래 1번(신규 셋업 실전 테스트)이 가장 높은 가치 — E2E 옵트인 경로(프리셋 권장 기본·§4.2 질문·U1 재감지·README 생성)가 실전에서 처음 주행되는 경로다.
